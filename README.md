# 👨‍💻 JavaScript Complete Course — Jonas Schmedtmann

Repository dedicated to my studies and projects developed during the course.
...
* **Monday** - 3/4 classes + exercise
* **Tuesday** - 3/4 classes + exercise
* **Wednesday** - review + remake without review
...
- [ ] Object-Oriented Programing with JS
- [ ] Mapty app : OOP, Geolocation,External Libraries and More!
- [ ] Asynchronous JS: Promises, Async/Await, and AJAX
- [ ] Modern JS development: Modules, Tooling, and Functional
- [ ] Forkify app: Building a Mordern application
- [ ] Setting up git and development
